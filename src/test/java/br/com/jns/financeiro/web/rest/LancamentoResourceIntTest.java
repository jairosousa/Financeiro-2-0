...
public class LancamentoResourceIntTest {
    ...
    private static final Long DEFAULT_NUMERO_PARCELAS = 1L;
    private static final Long UPDATED_NUMERO_PARCELAS = 2L;
    ...
    public void createLancamento() throws Exception {
        ...
        assertThat(testLancamento.getNumeroParcelas()).isEqualTo(DEFAULT_NUMERO_PARCELAS);
    ...
    public void checkTipoPagamentoIsRequired() throws Exception {
        int databaseSizeBeforeTest = lancamentoRepository.findAll().size();
        // set the field null
        lancamento.setTipoPagamento(null);
    ...
    @Test
    @Transactional
    public void checkNumeroParcelasIsRequired() throws Exception {
        int databaseSizeBeforeTest = lancamentoRepository.findAll().size();
        // set the field null
        lancamento.setNumeroParcelas(null);
    ...
    public void getAllLancamentos() throws Exception {
        ...
        restLancamentoMockMvc.perform(get("/api/lancamentos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numeroParcelas").value(hasItem(DEFAULT_NUMERO_PARCELAS.intValue())));
    }
    ...
    public void getLancamento() throws Exception {
        ...
        restLancamentoMockMvc.perform(get("/api/lancamentos/{id}", lancamento.getId()))
            ...
            .andExpect(jsonPath("$.numeroParcelas").value(DEFAULT_NUMERO_PARCELAS.intValue()));
    }
    ...
    public void updateLancamento() throws Exception {
        ...
        assertThat(testLancamento.getNumeroParcelas()).isEqualTo(UPDATED_NUMERO_PARCELAS);

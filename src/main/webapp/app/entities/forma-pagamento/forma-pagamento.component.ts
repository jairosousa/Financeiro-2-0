...
export class FormaPagamentoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.formaPagamentoService
                ...
                .subscribe(
                    (res: HttpResponse<IFormaPagamento[]>) => this.paginateFormaPagamentos(res.body, res.headers),
    ...
    protected paginateFormaPagamentos(data: IFormaPagamento[], headers: HttpHeaders) {

# financeiro [![Build Status](https://travis-ci.org/jairosousa/Financeiro-2-0.svg?branch=master)](https://travis-ci.org/jairosousa/Financeiro-2-0)
...
To optimize the financeiro application for production, run:
